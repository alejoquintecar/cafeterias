...
<table id="my-datatable" class="display my-datatable table-bordered bg-white" style="width:100%">
  <tfoot>
    <tr>
      <th class="bg-light" id="my-datatable-tfoot-buttons" colspan="6"></th>
    </tr>
  </tfoot>
</table>
...
<script>
  $("#loading").hide();
  var aRoutesUrls = {};
  aRoutesUrls.indexJson = 'productos-vender-json';
...
<!-- --- --- --- Controlador --- --- --- -->
<script src="assets/controllers/productosVender/index.js"></script>